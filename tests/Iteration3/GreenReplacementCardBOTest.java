...
class GreenReplacementCardBOTest {
    private GreenReplacementCardBO greenReplacementCardObj;
    private int id;
    ...
    void setUp() {
        ...
        this.homeAddress = new HomeAddress("123 Any Street", "Bakersfield", "CA", "93399");
        this.reasonForReplacement = "Card was lost.";

        greenReplacementCardObj = new GreenReplacementCardBO(id, firstName, middleName, lastName, dateOfBirth, countryOfBirth, homeAddress, reasonForReplacement);
    }
    ...
    @Test
    public void getFormTest(){ assertTrue(greenReplacementCardObj.getForm(this.id) instanceof GreenReplacementCardBO); }
    @Test
    ...
    public void setDateOfBirthTest(){
        Date newDateOfBirth = new GregorianCalendar(1975, Calendar.NOVEMBER, 11).getTime();
    ...
    public void setHomeAddressTest(){
        HomeAddress homeAddress = new HomeAddress("123 Apple Street", "Fairfax", "VA", "12312");
